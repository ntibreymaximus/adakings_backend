...
# Development-specific logging configuration - show ALL logs without any filters
LOGGING = {
    'version': 1,
    'disable_existing_loggers': False,
    'filters': {},  # No filters in development
    'formatters': {
        'verbose': {
    ...
    'loggers': {
        ...
        'django.server': {
            'handlers': ['console'],
            'level': 'DEBUG',  # Show all server logs in development
            'propagate': False,
        },
        'django.request': {
            'handlers': ['console'],
